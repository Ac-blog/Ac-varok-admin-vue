...
//         this.$nextTick(() => {
//           this.tinymce[0].setMode(newVal ? 'readonly' : 'design')
//         })
//       },
//     },
//   },
...
//     mcePreviewCommandEvent() {
//       this.$nextTick(() => {
//         const previewtToxDialog = document.querySelector('.tox-dialog')
//         const previewDialogFooterStartEle = document.querySelector(
//           '.tox-dialog-wrap .tox-dialog__footer .tox-dialog__footer-start'
//         )
